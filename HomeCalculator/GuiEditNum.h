...
public:
	...
	GuiEditNum(HWND owner, int id2, int x, int y, int width, int height) :
		GuiControl("EDIT", "", owner, id2, x, y, width, height, WS_BORDER | WS_CHILD | WS_VISIBLE | ES_CENTER | ES_NUMBER){}
