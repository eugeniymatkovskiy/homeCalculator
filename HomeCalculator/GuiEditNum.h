...
public:
	...
	GuiEditNum(HWND owner, int x, int y, int width, int height) :
		GuiControl("EDIT", "", owner, x, y, width, height, WS_BORDER | WS_CHILD | WS_VISIBLE | ES_CENTER ){}
	GuiEditNum(HWND owner, HMENU id, int x, int y, int width, int height) :
		GuiControl("EDIT", "", owner, id, x, y, width, height, WS_BORDER | WS_CHILD | WS_VISIBLE | ES_CENTER ){}
};